...
const SkillGroupInput = DynamicImport(() =>
  import("../templates/skillGroupInput")
);
const SkillGroupList = DynamicImport(() =>
  import("../templates/skillGroupList")
);
