        ...
        <div>
          ...
          <section className="breadcum">
            <div className="container text-center">
              ...
              <p>
                Là những câu chuyện đằng sau lý do hình thành các giải pháp của Pitech, nhằm giải quyết các vấn đề của
                xã hội hoặc nhu cầu đến từ phía người dùng.
              </p>
            </div>
          </section>
          {/* // Bread cum  */}
              ...
              <article className="article-box ">
                <div className="row article-detail">
                  <div className="col-12 col-xl-6 align-self-center">
                    <h3 className="d-none d-lg-block text-white text-left">LOREM IPSUM DOLOR</h3>
                  ...
                  <div className="col-12 col-xl-6 ">
                    <a href="#" target="_blank" rel="noopener noreferrer">
                      <div className="img-box">
                        <img className="img-fluid" src="./assets/images/laptop/article/teach-series-article-1.png" alt="feature article" />
          ...
          <section className="teach-series-sub-articles">
            <div className="container">
                    ...
                    <div className="article-detail secondary-article secondary-article--left">
                      <div className="row align-items-center">
                        <div className="col-12 col-xl-12 left-block">
                          <div className="img-box">
                            <img className="img-fluid thumbnail" src="./assets/images/laptop/article/world-control-clipping.png" alt="article" />
                            <img className="play-btn" src="./assets/images/mobile/icons/icn-play.png" alt="play" />
                          </div>
                        </div>
                        <div className="col-12 col-xl-12 right-block">
                          <a href="#" target="_blank" rel="noopener noreferrer">
                            <h3 className="text-black">Huawei Sound X - Loa thông minh Hi-Res Audio đầu tiên,
                              Devialet thiết kế, âm
                              thanh.</h3>
                            <p>
              ...
              {/* View more button */}
              <a href="#" className="text-uppercase mx-auto justify-content-center d-flex align-items-center view-more-articles">
                <span>
                  View more
                </span>
                <span>
